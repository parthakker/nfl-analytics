...
The mechanics matter less than the concept, which you can apply to any stat in this warehouse: compute a unit's raw performance, compute what an average unit would have done against those same opponents (opponents' EPA/play allowed, say), and take the difference. Iterate a couple of times so the opponent ratings themselves are adjusted, and you've built a power rating. Early in a season this adjustment is enormous — through four weeks, a team's schedule can be two standard deviations from neutral, and unadjusted EPA rankings in September routinely flatter whoever played the soft slate. The warehouse's strength-of-schedule and team-EPA views exist to make this correction easy rather than optional.
