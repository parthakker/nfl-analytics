...
def team(code: str, season: int = 2025) -> dict:
    ...
    with read_conn() as con:
        ...
        """, [code])
    return {"code": code, "season": season,
            "record": {"w": rec["w"] or 0, "l": (rec["g"] or 0) - (rec["w"] or 0),
                       "pf_pg": rec["pf_pg"], "pa_pg": rec["pa_pg"]},
